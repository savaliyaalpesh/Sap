    ...
    <div className="min-h-screen bg-white p-4 md:p-8 lg:p-12">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6 lg:gap-8 mt-8 md:mt-12">
          ...
          <div className="flex flex-col justify-center p-4 sm:p-6 bg-white rounded-lg shadow-sm">
            ...
            <div className="mt-4 md:mt-8">
              <h2 className="text-xl md:text-2xl font-bold text-gray-800 mb-4">Let's Discuss</h2>
              
              <div className="space-y-3 md:space-y-4">
                <div className="flex items-center">
                  <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-blue-100 flex items-center justify-center mr-3 md:mr-4 flex-shrink-0">
