    ...
    <>
      <div className="min-h-screen bg-white text-black font-sans">
        ...
        <div className="w-full h-56 flex flex-col items-center justify-center relative overflow-hidden bg-custom text-center px-auto">
          ...
          <h1 className="text-5xl font-bold text-white z-10">OS/DB Service</h1>
        </div>
        ...
        <div className="container mx-auto py-16 px-4 md:px-6">
          ...
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="w-full md:w-1/2 flex flex-col gap-4">
              <h2 className="text-4xl font-bold text-gray-900">Follow the Upwards Trajectory in Business Growth with SAP OS/DB Migration Services</h2>
          ...
          <div className="max-w-6xl mx-auto px-4 py-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {steps.map((step) => (
                ...
                >
                  ...
                  <h2 className="text-xl font-semibold text-left mb-2">{step.title}</h2>
                </div>
              ))}
            </div>
            ...
            <p className="text-gray-600">Our dedicated team handles all migration-related issues with excellent customer service and Importing the Database to Target System. Choose us for our expertise, reliability, and unwavering dedication to the best service. We will prioritise your satisfaction and success throughout the migration.</p>
          </div>
          ...
          <div className="container mx-auto py-20 px-4 md:px-6">
            ...
            <div className="flex flex-col md:flex-row items-center gap-8 mx-20">
              {/* Text content - left side */}
              <div className="w-full md:w-1/2 flex flex-col gap-4">
                <h2 className="text-4xl font-bold text-gray-900">Unleash the Real Power of SAP with OS/DB Migration Services</h2>
          ...
          <div className="mb-16">
            ...
            <div className="py-10">
              <h1 className="text-4xl font-bold text-gray-900 text-left">SAP MIGRATION – OS/DB SERVICES</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="border rounded-lg p-6 flex flex-col items-center text-center shadow-lg transition duration-300">
                ...
                <h4 className="text-xl font-semibold text-blue-500 mb-2">Homogeneous System Copy</h4>
              ...
              <div className="border rounded-lg p-6 flex flex-col items-center text-center shadow-lg transition duration-300">
                ...
                <h4 className="text-xl font-semibold text-blue-500 mb-2">Heterogeneous System Copy:</h4>
                <p className="text-gray-700 text-left my-3">
