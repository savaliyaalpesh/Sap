  ...
  const Faqs = () => {
    ...
    return (
      <div className="p-4 md:p-6  mx-auto w-full">
        <h1 className="text-3xl md:text-4xl font-bold text-center mb-6 md:mb-8 text-gray-900">FAQ</h1>
  ...
  return (
    <>
      <div className="min-h-screen bg-white text-black font-sans">
        ...
        <div className="w-full h-40 md:h-56 flex flex-col items-center justify-center relative overflow-hidden bg-custom text-center px-4">
          <div className="absolute inset-0 opacity-70"></div>
          <h1 className="text-3xl md:text-5xl font-bold text-white z-10">SAP cpi Consultant</h1>
        </div>
        ...
        <div className="container mx-auto py-8 md:py-16 px-4 md:px-6">
          ...
          <div className="flex flex-col md:flex-row items-center gap-6 md:gap-8">
            ...
            <div className="w-full md:w-1/2 flex flex-col gap-3 md:gap-4">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900">We Provide the Best Way to Your Digital Transformation</h2>
          ...
          <div className="flex flex-col md:flex-row items-start gap-6 md:gap-8 px-2 md:px-8 lg:px-28 py-6 md:py-10 mt-8 md:mt-12">
            {/* Left side content */}
            <div className="w-full md:w-1/2 flex flex-col gap-3 md:gap-4">
                ...
                >
                  <div className="mb-4">
                    <img
                      src={step.icon}
                      alt=""
                      className={`w-[40px] md:w-[50px] h-[40px] md:h-[50px] transition duration-300 ${selectedStep === step.id
          ...
          <div className="container mx-auto py-10 md:py-20 px-4 md:px-6">
            {/* Original content from the first component */}
            <div className="flex flex-col md:flex-row items-center gap-6 md:gap-8 mx-2 md:mx-4 lg:mx-20">
              {/* Text content - left side */}
              <div className="w-full md:w-1/2 flex flex-col gap-3 md:gap-4">
          ...
          <div className="flex flex-col md:flex-row items-center gap-6 md:gap-8 mx-2 md:mx-4 lg:mx-20">
            ...
            <div className="w-full md:w-1/2 flex flex-col gap-3 md:gap-4 my-6 md:my-10 order-1 md:order-2">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900">SAP PI/PO/CPI Services</h2>
      ...
      <div className="text-center  md:mb-8">
        ...
        <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 px-2">
          How Your Business can get benefitted from SAP PI/PO/CPI.
        </h1>
      </div>
