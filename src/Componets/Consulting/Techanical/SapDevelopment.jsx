    ...
    <>
      <div className="min-h-screen bg-white text-black font-sans">
        ...
        <div className="w-full h-40 flex flex-col items-center justify-center relative overflow-hidden bg-custom text-center px-4">
          ...
          <h1 className="text-5xl font-bold text-white z-10">SAP Abap Development</h1>
        </div>
        ...
        <div className="container mx-auto py-16 px-4 md:px-6">
          ...
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="w-full md:w-1/2 flex flex-col gap-4">
              <h2 className="text-4xl font-bold text-gray-900">Customized Solutions to Suit Your Business Needs</h2>
          ...
          <div className="max-w-6xl mx-auto px-4 py-8">
            ...
            <p className="text-gray-600">We collaborate with clients to find optimization and innovation opportunities to maximize SAP investment value.</p>
          </div>
          {/* Main content section */}
          <div className="container mx-auto py-20 px-4 md:px-6">
            ...
            <div className="flex flex-col md:flex-row items-center gap-8 mx-20">
              {/* Text content - left side */}
              <div className="w-full md:w-1/2 flex flex-col gap-4">
                <h2 className="text-4xl font-bold text-gray-900">Let Your Business Flourish through Our Customized SAP ABAP Solutions</h2>
          ...
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="w-full md:w-1/2 flex flex-col gap-4">
              <h2 className="text-4xl font-bold text-gray-900">SAP ABAP Development Services</h2>
