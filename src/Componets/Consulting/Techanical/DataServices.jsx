    ...
    <>
      <div className="min-h-screen bg-white text-black font-sans">
        ...
        <div className="w-full h-40 flex flex-col items-center justify-center relative overflow-hidden bg-custom text-center px-4">
          ...
          <h1 className="text-5xl font-bold text-white z-10">SAP Data Services Designer</h1>
        </div>
        ...
        <div className="container mx-auto py-16 px-4 md:px-6">
          ...
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="w-full md:w-1/2 flex flex-col gap-4">
              <h2 className="text-4xl font-bold text-gray-900">Uncover Your Business Possibilities with Data</h2>
          ...
          <div className="container mx-auto py-20 px-4 md:px-6">
            ...
            <div className="flex flex-col md:flex-row items-center gap-8 mx-20">
              {/* Text content - left side */}
              <div className="w-full md:w-1/2 flex flex-col gap-4">
                <h2 className="text-4xl font-bold text-gray-900">Fueling the Growth of Businesses through Data Quality, Integration, and Transformation</h2>
          ...
          <div className="container mx-auto py-20 px-4 md:px-6">
            ...
            <div className="flex flex-col md:flex-row items-center gap-8 mx-20">
              ...
              {/* Text content - left side */}
              <div className="w-full md:w-1/2 flex flex-col gap-4">
                <h2 className="text-4xl font-bold text-gray-900">SAP Data Services</h2>
