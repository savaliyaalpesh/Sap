...
const SapBasis = () => {
  ...
  const Faqs = () => {
    ...
    return (
      <div className="p-4 sm:p-6 max-w-4xl mx-auto min-w-full">
    ...
    <>
      <div className="min-h-screen bg-white text-black font-sans">
        ...
        <div className="w-full h-40 flex flex-col items-center justify-center relative overflow-hidden bg-custom text-center px-4">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white z-10">SAP Basis Consultantation</h1>
        </div>
        ...
        <div className="container mx-auto py-8 sm:py-12 md:py-16 px-4 md:px-6">
          ...
          <div className="flex flex-col md:flex-row items-center gap-6 md:gap-8">
            ...
            <div className="w-full md:w-1/2 flex flex-col gap-4">
              <h2 className="text-3xl sm:text-4xl font-bold text-gray-900">Establish the Core for Digitalization of Your Business with SAP BASIS</h2>
          ...
          <div className="flex flex-col md:flex-row items-start gap-6 sm:gap-8 px-2 sm:px-4 md:px-16 lg:px-28 py-8 sm:py-10 mt-8 sm:mt-12">
            {/* Left side content */}
            <div className="w-full md:w-1/2 flex flex-col gap-4">
          ...
          <div className="max-w-6xl mx-auto px-4 py-8">
            ...
            <p className="text-gray-600 mt-4">Our <b>sap basis consultant</b> in India offers unmatched expertise, seamless solutions, and transformative digital business strategies. </p>
          </div>

          {/* Main content section */}
          <div className="container mx-auto py-10 sm:py-16 md:py-20 px-4 md:px-6">
            {/* Original content from the first component */}
            <div className="flex flex-col md:flex-row items-center gap-6 sm:gap-8 mx-2 sm:mx-6 md:mx-10 lg:mx-20">
              {/* Text content - left side */}
              <div className="w-full md:w-1/2 flex flex-col gap-4">
                <h2 className="text-3xl sm:text-4xl font-bold text-gray-900">We allocate the best suitable resource for your requirement</h2>
          ...
          {/* Introduction text */}
          <div className="bg-blue-50 pt-6 sm:pt-10 pb-10 sm:pb-20 px-4 sm:px-6">
            {/* Text content - centered */}
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 text-center mb-6">SAP BASIS Services</h2>
