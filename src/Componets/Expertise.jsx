...
const SAPExpertiseSection = () => {
  ...
  const serviceCards = [
    ...
    },
    {
      title: "SAP AMS /AMO",
      icon: "M11.42 15.17 17.25 21A2.652 2.652 0 0 0 21 17.25l-5.877-5.877M11.42 15.17l2.496-3.03c.317-.384.74-.626 1.208-.766M11.42 15.17l-4.655 5.653a2.548 2.548 0 1 1-3.586-3.586l6.837-5.63m5.108-.233c.55-.164 1.163-.188 1.743-.14a4.5 4.5 0 0 0 4.486-6.336l-3.276 3.277a3.004 3.004 0 0 1-2.25-2.25l3.276-3.276a4.5 4.5 0 0 0-6.336 4.486c.091 1.076-.071 2.264-.904 2.95l-.102.085m-1.745 1.437L5.909 7.5H4.5L2.25 3.75l1.5-1.5L7.5 4.5v1.409l4.26 4.26m-1.745 1.437 1.745-1.437m6.615 8.206L15.75 15.75M4.867 19.125h.008v.008h-.008v-.008Z",
      items: ["Technical Support", "Functional Support", "SAP Application Support", "Security Services", "Optimization & Enhancement Services", "SAP Basis Administration Services", "Add-On Services"]
    },
    {
      title: "Our SAP Solutions​",
      icon: "M12 18v-5.25m0 0a6.01 6.01 0 0 0 1.5-.189m-1.5.189a6.01 6.01 0 0 1-1.5-.189m3.75 7.478a12.06 12.06 0 0 1-4.5 0m3.75 2.383a14.406 14.406 0 0 1-3 0M14.25 18v-.192c0-.983.658-1.823 1.508-2.316a7.5 7.5 0 1 0-7.517 0c.85.493 1.509 1.333 1.509 2.316V18",
      items: ["GST Solutions", "E-Way Bill Solutions", "E- Invoicing Solutions", "194Q/R Solutions", "TCS Solutions", "Weightbridge Integration"]
    }
  ];

  // Card component for reusability
  const ServiceCard = ({ title, icon, items, isLastRow }) => (
    <div className={`bg-white rounded-lg p-6 relative shadow-sm h-full ${isLastRow ? 'mt-10' : ''}`}>
      <div className="absolute -top-10 left-8">
        <div className="bg-blue-100 rounded-b-full w-24 h-24 flex items-center justify-center">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-10 h-10 text-blue-800">
        ...
        <ul className="space-y-3">
          {items.map((item, index) => (
            <li key={index} className="flex items-start">
              {/* Perfect square checkbox with inner color and checked appearance */}
              <div className="w-5 h-5 mr-2 mt-1 flex-shrink-0 relative opacity-75 cursor-not-allowed">
                {/* Square border */}
                <div className="absolute inset-0 border-2 border-blue-500"></div>
                {/* Filled background */}
                <div className="absolute inset-0.5 bg-blue-100"></div>
                {/* Checkmark */}
                <svg className="absolute inset-0 text-blue-500 w-full h-full" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="mt-8 text-blue-500 font-medium flex items-center">
            <span>Know More</span>
    ...
    <div className="bg-gray-100 p-6 md:p-12 w-full">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-16">
          <h3 className="text-blue-400 font-medium mb-3">OUR EXPERTISE</h3>
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900">
            SAP Implementation and Technical Consultation<br className="hidden md:block" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
          {serviceCards.map((card, index) => {
            ...
            const isLastRow = index >= 3 && index <= 4;
...
const SAPSolutions = () => {
  const solutions = [
    ...
    },
    {
      title: 'SAP BTP',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" className="w-8 h-8">
          <rect x="5" y="8" width="14" height="10" rx="1" />
          <path d="M7 15h10" />
          <path d="M7 12h10" />
          <path d="M7 9h2" />
    ...
    <div className="bg-stone-100 p-8 md:p-12">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <h3 className="text-blue-400 font-medium mb-4 tracking-wider">OUR SAP SOLUTIONS</h3>
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900">Business Ready SAP Solutions</h2>
        </div>
          ...
          {solutions.map((solution, index) => (
            <div key={index} className="flex flex-col items-center w-56">
              <div className="relative mb-2">
                ...
                {/* Vertical line */}
                <div className="h-6 w-0.5 bg-blue-400 mx-auto mb-1"></div>
                
                {/* Dot */}
                <div className="w-2.5 h-2.5 rounded-full bg-blue-400 mx-auto"></div>
              </div>
